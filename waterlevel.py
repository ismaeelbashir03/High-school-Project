def water():
    ...
    import waterboss as b    #imports the boss class

    import waterball   #imports fireball class

    import water as w           #imports water class

    import start            #imports start area

    import mysql.connector      #imports the mysql connector

    from warning import Warning_sign        #imports warning sign
    ...
    pygame.display.set_caption("water level")       # Name your window
    ...
    bg = pygame.image.load("assets/water/waterbgimg.png").convert()
    ...
    #creates var fr sql save
    sql_watersave = "UPDATE player SET waterunlock = 1, waterfinish = 1 WHERE active = 1"
    ...
    def redrawscreen(screen, bg, player, smallfont):
        ...
        #blits the water to screen
        waters.draw(screen)

        #draws the warning on to screen
    ...
    def opentilemap():
        ...
        file = open("assets/water/waterleveltilemap.csv", "r")
    ...
    def drawinglevel(tilesize, music, x, y):
        ...
        #returns values
        return boss, player, tiles, water
    ...
    boss, player, tiles, water = drawinglevel(tilesize, music, x, y)
    ...
    while done == False and died == False:
        ...
        #calls function to rise water
        boss.waterstate(water, player)

        #opens boss death check
        done = boss.checkdead()
        
        #calls the boss attack function
        fireballs, warnings = boss.attack(waterball.Fireball, fireballs, player, warnings, Warning_sign)

        #calls function to kill wanring
    ...
    #sets the reason for exit initially to won
    reason = "won"
